...
public interface BudgetRepository extends JpaRepository<Budget, Long> {
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE budget SET amount_spent = :amountSpent, category = :category, budget = :budget, amount_to_Budget = :amountToBudget WHERE budgetID = :budgetID", nativeQuery = true)
